...
import img1 from "../assets/inter 1.png";
    ...
    <div className="bg-black tracking-wider overflow-x-clip">
      ...
      <div className="h-[50vh] md:h-screen relative">
        <div className="absolute   left-1/2 top-0 -translate-x-1/2 flex flex-col items-center">
          <div className="w-1/4 aspect-square bg-contain bg-black border-2 rounded-full">
            <img  src="https://images.unsplash.com/photo-1661546820803-a30a643279e9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=386&q=80" className=" rounded-full bg-contain w-full" />
          </div>
          {/* <div className="text-white text-base lg:text-2xl font-semibold px-2 my-16 flex justify-center w-[200%] md:w-full h-[45%] overflow-scroll"> */}
            ...
            <p className="text-center text-white text-base lg:text-2xl font-semibold px-2 mt-16 mb-5 flex justify-center w-[200%] md:w-full h-[45%] ">
      ...
      <div className="h-1/2 md:flex mt-24 ">
